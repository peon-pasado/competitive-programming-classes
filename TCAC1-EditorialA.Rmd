...
Una de las estrategias óptimas en este problema es ubicar un nodo en $a$ con la mayor cantidad de filas de información, luego mover toda la información del cluster al que no pertenece $a$ hacia $a$. Luego de esto basta intentar para el resto de nodos del clúster de $a$ la mejor de dos opciones: Mover toda la información del otro cluster a esa posición o mover la información del nodo actual al $a$.
