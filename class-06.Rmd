...
**Problema:** Recibirás un array $n$ de $n$ elementos. Debes imprimir la menor
...
y un entero $x$. Debes imprimir dos números $i, j \mid i \not = j \land a_i
...
* $a[l] + a[r] < target$
  ...
  En este caso necesitamos obtener una suma menor. Disminuir $r$ solo hará que
...
¿ Como podríamos resolver el problema si ahora necesitaramos encontrar tres
números $x, y, z \mid x \not = y \not = z \land a_x + a_y + a_z = target$ ?

<div class="topic">Contribution technique</div>

Esta técnica nos puede ayudar a redicir cálculos con muchas variables
...
Notamos que necesitamos algo menor que una solución $O(n^3)$.
...
Notemos que $abcdefghij$ será una permutación de $0123456789$. Luego, podemos
...
L es la cantidad máximo de dígitos de los números.
...
una solución en $O(n * n * k)$ donde $k$ es el tamaño de la secuencia más
...
* [Competitive Programmer’s Handbook, chapters 5, 8](https://jadi.net/wp-content/uploads/2017/07/competetive-programmers-handbook.pdf)
