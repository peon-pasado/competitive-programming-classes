...
Ahora, centrémonos en calcular eficientemente $S(x)$
...
Sea $num = \overline{p_np_{n-1}\dots p_{k +1}p_{k}k_{k -1}\dots p_{1}}$ (podemos considerar que $num$ siempre tiene `n` dígitos por simplicidad - si tiene menos de `n` dígitos simplemente podemos agregarle ceros al inicio y no afectará la respuesta -)
